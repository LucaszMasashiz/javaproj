...
/**
 * Tela de exibição do histórico de buscas, músicas curtidas e descurtidas do usuário autenticado.
 * 
 * Exibe as últimas 10 buscas, todas as músicas curtidas e descurtidas, e permite descurtir músicas diretamente pela interface.
 * O fundo da tela é azul acinzentado.
 * 
 * @author Masashi
 */
public class Historico extends javax.swing.JFrame {
    ...
    /**
     * Construtor da tela Historico. Inicializa componentes e carrega dados do usuário autenticado.
     */
    public Historico() {
        initComponents();
    ...
    /**
     * Carrega e exibe os últimos 10 termos de busca realizados pelo usuário autenticado.
     */
    ...
    /**
     * Carrega e exibe todas as músicas curtidas pelo usuário autenticado.
     * Cada música é exibida pelo nome.
     */
    ...
    /**
     * Carrega e exibe todas as músicas descurtidas pelo usuário autenticado.
     * Cada música é exibida pelo nome.
     */
    ...
    /**
     * Evento do botão "Voltar". Volta para a tela Home.
     * 
    ...
    /**
     * Evento do botão "Descurtir". Remove a música da lista de curtidas do usuário e coloca na lista de descurtidas.
     * 
     * @param evt Evento de clique do botão.
     */
    ...
    /**
     * Método principal. Inicializa a tela de histórico.
     * 
